...
bool MainWindow::lireformateurs(formateurs &value)
{
    ...
    QString specialite = ui->specialite_formateur->text().trimmed();
...
void MainWindow::on_bt_vider_formateur_clicked()
{
    id_formateur = 0;
...
void MainWindow::on_tableView_formateur_clicked(const QModelIndex &index)
{
    ...
    ui->specialite_formateur->setText(model->index(index.row(), 6).data().toString());
...
void MainWindow::on_bt_stat_formateur_clicked() { statistiques("formateurs"); }
